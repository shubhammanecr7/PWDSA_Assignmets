...
public class Q5 {
	/*
	 * Q5. Given a directed graph, check whether it has an Eulerian path or not. An
	 * Eulerian path (or Eulerian trail) is a path in a graph that visits every edge
	 * exactly once.
	 */
	
	// Function to perform DFS traversal on the graph
    public static void DFS(Graph5 graph, int v, boolean[] discovered)
    {
    ...
    public static Graph5 getUndirectedGraph(Graph5 graph, int n)
    {
    ...
    public static boolean isConnected(Graph5 graph, int n)
    {
    ...
    public static boolean hasEulerPath(Graph5 graph, int n)
    {
        /*
    ...
    public static void main(String[] args)
    {
        ...
        List<Edge5> edges = Arrays.asList(new Edge5(0, 1), new Edge5(1, 2),
                new Edge5(2, 3), new Edge5(3, 1), new Edge5(1, 4), new Edge5(4, 3),
                new Edge5(3, 0), new Edge5(0, 5), new Edge5(5, 4)
        );
